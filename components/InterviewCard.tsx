...
const InterviewCard = (props: InterviewCardProps) => {
  ...
  const interviewIdNum = parseInt(props.interviewId || "0") || 0;
  const coverSrc = getInterviewCover(interviewIdNum);

  const formattedDate = dayjs(feedback?.createdAt || props.createdAt || "2024-01-01").format('DD-MM-YYYY');
    ...
    <div className="card-border w-[360] max-sm:w-full min-h-[96]">
      <div className="card-interview">
        <div>
          ...
          <Image src={coverSrc} alt="cover image" width={90} height={90} className="rounded-full"></Image>
